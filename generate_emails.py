...
SUBJECT_TEMPLATE = "Simple Website Demo for {business_name} Facebook Page"
...
<head>
  ...
  <title>Roofing Outreach Emails ({len(leads)} leads)</title>
...
<body>
  ...
  <header class="site-header">
    <div class="header-title">Roofing Outreach &mdash; <span>Email Viewer</span></div>
...
def main():
    ...
    output_dir  = "output"
    output_path = os.path.join(output_dir, "outreach_emails.html")
    ...
    for r in range(3, ws.max_row + 1):
        ...
        raw_email   = ws.cell(row=r, column=5).value
